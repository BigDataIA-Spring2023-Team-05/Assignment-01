...
class TestGOESSatelliteLink(unittest.TestCase):
    def getawsfileurl(base_url, filename):
            y = filename.split('_')
            # print(y)
            filename_pattern = r'(.*)-(.*)'
...
# filename = 'OR_ABI-L1b-RadM1-M6C01_G18_s20230030201252_e20230030201311_c20230030201340.nc'
# x = TestGOESSatelliteLink.getawsfileurl(base_url, filename)
# print(x)
...
for i in test_files:
  print(TestGOESSatelliteLink.getawsfileurl(base_url,i))
